...
class GoogleSheetClient:
    def __init__(self, path_to_credentials, sheet_name, inner_sheet_name):
    ...
    def load_from_sheet(self, sheet_name, path_to_credentials, start, end, current_user):
        records = self.sheet_c.get_all_records
        return records
